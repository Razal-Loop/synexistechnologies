            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl bg-slate-900 border border-brand-primary/20 rounded-[2.5rem] shadow-[0_0_50px_-12px_rgba(59,130,246,0.3)] p-10 overflow-hidden"
                    >
